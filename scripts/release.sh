#!/usr/bin/env bash
#
# scripts/release.sh: opinionated release preparation wrapper for EidosDB.
#
# Usage:
...
new_links = (
    "[Unreleased]: https://github.com/nubster-opensources/eidosdb/compare/v"
    + new_version
    + "...HEAD\n["
    + new_version
    + "]: https://github.com/nubster-opensources/eidosdb/releases/tag/v"
    + new_version
)
